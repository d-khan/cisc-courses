...
|-|---------|-|
|A| 90-100  |Work of genuinely superior quality.|
...
|F| 0-64    |Failing performance that does not satisfy the basic requirements of the course and needs to be improved in significant ways.|
