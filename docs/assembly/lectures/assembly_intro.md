...
[How to execute your first assembly language code](https://youtu.be/4IZSh1WVyi8)
...
A. Execute assembly language programs directly  
B. Convert assembly language into machine code  
C. Translate assembly language into Python  
D. Optimize operating systems

<details>
<summary>Show Answer</summary>

Answer: B. Convert assembly language into machine code

An assembler translates human-readable assembly instructions into machine language instructions that the processor can execute.
...
### Question 2
Which assembly language section is used for storing initialized data?
...
The .data section contains initialized variables and constants whose values are known before program execution.
...
A. Add 4 to EAX  
B. Move the contents of EAX to memory  
C. Load the value 4 into EAX  
D. Multiply EAX by 4

<details>
<summary>Show Answer</summary>

Answer: C. Load the value 4 into EAX

The MOV instruction copies data from the source operand into the destination operand.
...
### Question 4
Which register is commonly used as a loop counter in assembly language?
...
ECX is known as the count register and is commonly used in loops and repetitive operations.
...
### Question 5
Which NASM directive reserves one byte of uninitialized memory?
...
RESB reserves one or more bytes of uninitialized storage in the .bss section.
...
What is actually stored in ECX?

A. The first character of the string  
B. The length of the string  
C. The memory address of msg  
D. The ASCII value of msg

<details>
<summary>Show Answer</summary>

Answer: C. The memory address of msg

The label msg represents the starting address of the string stored in memory.
...
### Question 7
In the Hello World example, what is the purpose of the following statement?

```assembly 
len equ $ - msg
```

A. Allocates memory for len  
B. Calculates the string length  
C. Creates a pointer to msg  
D. Reserves a byte in memory

<details>
<summary>Show Answer</summary>

Answer: B. Calculates the string length

The symbol $ represents the current location counter. Subtracting msg from it gives the length of the string.
...
### Question 8
Which registers must be configured before executing the following syscall?
...
B. Only EBX  
C. Only ECX and EDX  
D. EAX and any registers required by the specific syscall

<details>
<summary>Show Answer</summary>

Answer: D. EAX and any registers required by the specific syscall

EAX contains the syscall number, while other registers hold syscall parameters depending on the operation being performed.
...
DW stands for Define Word, and a word is 2 bytes in x86 assembly.
...
### Question 10
Why is assembly language considered machine-dependent?

A. It only runs on Linux  
B. It cannot interact with hardware  
C. Each processor architecture has its own instruction set  
D. It requires a compiler

<details>
<summary>Show Answer</summary>

Answer: C. Each processor architecture has its own instruction set

Assembly language instructions are tied directly to a processor's architecture and instruction set, making assembly programs generally non-portable across different CPU families.
...
### Question 11
The following code prints a message to the screen:
...
What is the purpose of register EDX?

A. Stores the file descriptor  
B. Stores the syscall number  
C. Stores the address of the string  
D. Stores the number of bytes to write

<details>
<summary>Show Answer</summary>

Answer: D. Stores the number of bytes to write
