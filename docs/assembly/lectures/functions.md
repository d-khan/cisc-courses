...
<h3>Q1. Stack Growth Direction</h3>

<p>
In the x86 architecture, when values are pushed onto the stack, does the stack grow toward higher memory addresses or lower memory addresses?
</p>
...
<p>
Each PUSH operation decreases the value stored in the ESP register.
</p>

<p><strong>Answer:</strong> The stack grows toward lower memory addresses.</p>

</details>

<hr>

<h3>Q2. PUSH Instruction</h3>

<p>
What happens internally when the following instruction executes?
</p>
...
<p>
The PUSH instruction performs two operations:
</p>
...
<p>
First, ESP is decremented by 4 bytes. Then the contents of EAX are stored at the new stack location.
</p>

<p><strong>Answer:</strong> ESP decreases by 4 and the value in EAX is stored on the stack.</p>

</details>

<hr>

<h3>Q3. POP Instruction</h3>

<p>
Assume the top of the stack contains the value 25. What will be the value of EAX after executing the following instruction?
</p>
...
<p>
POP copies the value at the top of the stack into EAX and then increases ESP by 4 bytes.
</p>

<p>
Since the top of the stack contains 25:
</p>
...
<p><strong>Answer:</strong> EAX will contain 25.</p>

</details>

<hr>

<h3>Q4. Function Prologue</h3>

<p>
What is the purpose of the following function prologue?
</p>
...
<ul>
<li>Saves the caller's base pointer (EBP).</li>
<li>Creates a new stack frame for the current function.</li>
<li>Allocates 16 bytes of space for local variables.</li>
</ul>

<p><strong>Answer:</strong> It saves the previous stack frame and allocates memory for local variables.</p>

</details>

<hr>

<h3>Q5. Function Arguments</h3>
...
<p>
Inside the function, which argument is accessed using <code>[ebp+8]</code>?
</p>
...
<p><strong>Answer:</strong> The value 67 is accessed using <code>[ebp+8]</code>.</p>
