...
!!! info "Learning Outcomes"
    ...
    - Explain the purpose and operation of basic logic gates including NOT, AND, OR, NAND, and NOR.
    - Describe how logic gates are implemented using transistors and how they form the foundation of digital circuits.
    - Apply Boolean algebra operators and evaluate Boolean expressions using the correct order of precedence.
    - Convert between Boolean equations, truth tables, timing diagrams, and logic circuits.
    - Distinguish between combinational and sequential circuits.
    - Simplify Boolean expressions using Boolean algebra properties and DeMorgan's Law.
    - Construct and simplify circuits using sum-of-products and sum-of-minterms forms.
    - Create and interpret truth tables for Boolean functions.
    - Use Karnaugh Maps (K-Maps) to minimize Boolean expressions and design simpler digital circuits.
    - Explain why NAND and NOR gates are considered universal gates.
    - Describe the operation of SR latches, D latches, D flip-flops, and registers.
    - Explain the role of clocks, clock cycles, clock frequency, and edge-triggered storage in digital systems.
    - Analyze simple real-world digital systems using Boolean logic and sequential circuit concepts.
    - Apply Boolean algebra techniques to reduce circuit complexity, improve efficiency, and simplify troubleshooting.
...
### Question 1
Convert the following Boolean equation into a simplified form:
...
### Question 2
A truth table has 16 rows. How many input variables does the function have?
...
The function has <b>4 input variables</b>.
...
### Question 3
Determine whether the following circuit is combinational or sequential:

```text
A circuit contains several AND and OR gates.
No latches, flip-flops, or registers are present.
```

<details>
<summary>Show Answer</summary>

The circuit is <b>combinational</b> because its output depends only on the current inputs and no memory elements are present.
...
### Question 4
Apply DeMorgan's Law to simplify:
...
Complement each variable and change OR to AND:
...
### Question 6
Convert the following expression into sum-of-minterms form:

```text
y = ab + c
```

Assume variables a, b, and c.

<details>
<summary>Show Answer</summary>

Expand the missing variable in the first term:
...
### Question 7
Use K-map concepts to simplify:
...
an SR latch holds its previous state.
...
What logic operation does this represent?
...
is the standard Boolean equation for:
